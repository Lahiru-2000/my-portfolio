...
export default function Hero() {
  return (
    <motion.div
      ...
      className="flex max-w-[80%] mx-auto bg-black xl:h-[92vh] xl:justify-between items-center text-white max-xl:flex-col"
    >
      {/* Left Section */}
      <div className="flex sm:flex-col max-sm:flex-col max-sm:justify-center space-y-6 max-xl:h-[92vh] max-xl:justify-center xl:max-w-[60%]">
        <motion.div
        ...
        <motion.div
          ...
          className="sm:hidden"
        >
          <span className="text-[35px] font-semibold text-white sm:bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent flex flex-wrap text-center justify-center">
            Hello! I'm Lahiru Jayarathne
          </span>
        </motion.div>
        ...
        >
          <span className="flex max-sm:text-[15px] max-sm:flex-wrap max-sm:text-center font-futura xl:text-[18px] text-[16px] tracking-wide text-gray-300 max-xl:text-center">
      ...
      <motion.div
        ...
        className="relative max-xl:px-5 max-xl:max-w-[400px] max-xl:pt-[50px]"
      >
        <div className="rounded-[50%] overflow-hidden shadow-2xl border-4 border-gray-600 p-2">
          <Image
